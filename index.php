...
<section>
    ...
    <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/P_Gv7dCpLLk?controls=0?autoplay=1&mute=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
										...
										<li class="item">
											 <div class="row full contenedor_programa">
													 <div class="large-5 medium-5 columns logo_programa">
                                                        <a href="<?php echo get_field('playlist_url');?>">
